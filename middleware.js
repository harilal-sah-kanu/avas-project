...
const { listingSchema, reviewSchema } = require("./validators/schemas.js");
...
const validateListing = (req, res, next) => {
  // Ensure features are always arrays before validation
  if (req.body.listing) {
    if (
      req.body.listing.features &&
      !Array.isArray(req.body.listing.features)
    ) {
